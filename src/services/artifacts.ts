...
export async function writeJson(p: string, data: any) { await fs.writeFile(p, JSON.stringify(data, null, 2), "utf-8"); }
export function pathJoin(...p: string[]) { return join(...p); }
