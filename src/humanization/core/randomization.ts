...
export function microJitterPoints(center: Point, amplitudePx = 0.8, count = 6, decay = 0.85): Point[] {
  const pts: Point[] = []
...
export const QWERTY_NEIGHBORS: Record<string, string[]> = {
  ...
  m: ["n", "j", "k"], n: ["b", "h", "j", "m"], o: ["i", "k", "l", "p"], p: ["o", "l"], q: ["w", "a"], r: ["e", "d", "f", "t"],
  s: ["a", "w", "e", "d", "x", "z"], t: ["r", "f", "g", "y"], u: ["y", "h", "j", "i"], v: ["c", "f", "g", "b"],
