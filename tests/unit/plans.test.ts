...
describe("plans", () => {
  it("scroll plan length matches segments and includes pauses", () => {
    const segs = planScroll(1200, { segments: 6, microPauseChance: 1, microPauseMinMs: 50, microPauseMaxMs: 50, macroPauseEvery: 3, macroPauseMinMs: 100, macroPauseMaxMs: 100 })
