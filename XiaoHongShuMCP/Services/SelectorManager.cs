...
{
    /// <summary>
    /// 选择器管理服务，提供UI动态容错能力和页面状态感知
    /// 支持基于页面状态的智能选择器切换
    /// </summary>
    public class SelectorManager : ISelectorManager
    {
        ...
        public SelectorManager()
        {
            ...
            _selectors = new Dictionary<string, List<string>>
            {
                ...
                // 个人页面容器 - 识别是否在个人页面
                { "UserPageContainer", new List<string> {
                ...
                // 用户头像区域 - 个人页面专用
                { "UserPageAvatar", new List<string> {
                ...
                // 个人简介 - 个人页面专用
                { "UserDescription", new List<string> {
                ...
                // 关注数 - 个人页面统计
                { "UserFollowingCount", new List<string> {
                ...
                // 粉丝数 - 个人页面统计
                { "UserFollowersCount", new List<string> {
                ...
                // 获赞与收藏数 - 个人页面统计
                { "UserLikesCollectsCount", new List<string> {
                ...
                // 认证图标 - 识别认证用户
                { "UserVerifyIcon", new List<string> {
                ...
                // 关注按钮 - 个人页面操作
                { "UserFollowButton", new List<string> {
                ...
                // 更多操作按钮 - 个人页面
                { "UserMoreActions", new List<string> {
                ...
                // 空内容提示 - 个人页面
                { "UserPageEmptyContent", new List<string> {
                ...
                // 侧边栏发布按钮 - 基于真实HTML结构
                { "SidebarPublishButton", new List<string> {
                    ...
                    "[data-testid='sidebar-publish']"  // 测试ID备用
                } },
                
                // 侧边栏用户信息链接 - 基于真实HTML结构
                { "SidebarUserProfile", new List<string> {
                    ...
                    "[data-testid='sidebar-user-profile']"  // 测试ID备用
                } },
                
                // 侧边栏导航项通用选择器
                { "SidebarNavItem", new List<string> {
                    ".channel-list-content li",  // 导航列表项
                    ".side-bar-component",  // 侧边栏组件
                    ".link-wrapper",  // 通用链接包装器
                    ".bottom-channel",  // 底部导航项
                    "[data-testid='sidebar-nav-item']"  // 测试ID备用
                } },
                
                // 侧边栏发现页面链接
                { "SidebarDiscoverLink", new List<string> {
                    "a[href*='/explore?channel_id=homefeed_recommend']",  // 真实发现页面链接
                ...
                // 笔记类型筛选选项
                { "NoteTypeVideo", new List<string> {
                    ".tags:has(span:has-text('视频'))",  // 视频类型
                    "span:has-text('视频')",
                    "[data-testid='note-type-video']"
                } },
                
                { "NoteTypeImage", new List<string> {
                ...
                // 笔记隐藏链接 - 优先提取（更稳定）
                { "NoteHiddenLink", new List<string> {
                ...
                // 笔记显示链接 - 备选方案
                { "NoteVisibleLink", new List<string> {
                ...
                // 笔记封面图片
                { "NoteCoverImage", new List<string> {
                ...
                // 发布页容器 - Vue.js创作平台特化
                { "PublishContainer", new List<string> { 
                    ".publish-container", 
                    ".create-note", 
                    ".publisher-wrapper",
                    "#publish-page",
                ...
                { "ImageUploadArea", new List<string> {
                    ".upload-area",
                    ".image-uploader", 
                    ".file-drop-zone",
                    ".drop-zone",
                ...
                // 图片上传外层容器 - 基于真实HTML结构
                { "ImageUploadWrapper", new List<string> {
                ...
                // 拖拽上传区域 - 基于真实HTML结构
                { "DragUploadArea", new List<string> {
                    ".drag-over",  // 真实class名
                ...
                { "ImageSelectButton", new List<string> {
                ...
                // 上传进度指示器
                { "UploadProgress", new List<string> {
                    ".upload-progress",
                    ".progress-bar",
                    ".uploading",
                    ".upload-status",
                ...
                // 编辑器容器 - Vue.js特化
                { "EditorContainer", new List<string> {
                    ".editor-container",
                    ".rich-editor",
                    ".text-editor",
                    ".vue-editor",
                ...
                { "PublishTitleInput", new List<string> { 
                ...
                { "PublishContentInput", new List<string> { 
                ...
                // 标签输入框 - Vue.js特化
                { "PublishTagInput", new List<string> { 
                    ".tag-input", 
                    ".hashtag-input",
                    ".topic-input",
                ...
                // 暂存离开按钮 - 基于真实HTML结构
                { "TemporarySaveButton", new List<string> { 
                ...
                // Vue.js数据绑定元素
                { "VueDataElement", new List<string> {
                    "[v-model]",
                    "[v-bind]",
                    "[data-v-*]",
                    ".v-enter",
                ...
                // 动态渲染的表单元素
                { "DynamicFormElement", new List<string> {
                    "[data-dynamic='true']",
                    ".dynamic-field",
                ...
                // 位置选择器
                { "LocationSelector", new List<string> {
                    ".location-selector",
                    ".place-selector",
                ...
                // 加载指示器
                { "LoadingIndicator", new List<string> {
                    ".loading",
                    ".spinner",
                    ".loading-wrapper",
                    "[data-testid='loading']",
                ...
                // 笔记详情页面模态框容器
                { "NoteDetailModal", new List<string> {
                ...
                // 详情页关闭按钮
                { "NoteDetailCloseButton", new List<string> {
                ...
                // 详情页笔记标题（区别于列表页标题）
                { "NoteDetailTitle", new List<string> {
                ...
                // 详情页作者信息（区别于列表页作者）
                { "NoteDetailAuthor", new List<string> {
                ...
                // 详情页作者头像
                { "NoteDetailAuthorAvatar", new List<string> {
                ...
                // 单个评论项（详情页专用）
                { "CommentItemDetail", new List<string> {
                ...
                // 子评论项
                { "CommentItemSub", new List<string> {
                ...
                // 评论作者名（详情页专用）
                { "CommentAuthorDetail", new List<string> {
                ...
                // 评论内容（详情页专用）
                { "CommentContentDetail", new List<string> {
                ...
                // 评论点赞数（详情页专用）
                { "CommentLikeCountDetail", new List<string> {
                ...
                // 评论回复数
                { "CommentReplyCount", new List<string> {
                ...
                // 评论时间和地点
                { "CommentDateTime", new List<string> {
                ...
                // 详情页评论输入框
                { "DetailPageCommentInput", new List<string> {
                ...
                // 详情页评论发送按钮
                { "DetailPageCommentSubmit", new List<string> {
                ...
                // 详情页评论取消按钮
                { "DetailPageCommentCancel", new List<string> {
                ...
                { "EngageBarActive", new List<string> {
                ...
                { "CommentInputReady", new List<string> {
                ...
                // 发送按钮状态检测 - 区分启用和禁用状态
                { "CommentSubmitEnabled", new List<string> {
                ...
                { "CommentSubmitDisabled", new List<string> {
                ...
                // 最近使用的表情符号区域
                { "RecentEmojiArea", new List<string> {
                ...
                // 单个表情符号点击区域
                { "EmojiClickArea", new List<string> {
                ...
                // 表情符号触发按钮
                { "EmojiTriggerButton", new List<string> {
                ...
                // @提及触发按钮
                { "MentionTriggerButton", new List<string> {
                ...
                // 右侧按钮区域（发送+取消）
                { "RightButtonArea", new List<string> {
                ...
                // 动态点赞数 - 支持实时更新
                { "DynamicLikeCount", new List<string> {
                ...
                // 动态收藏数 - 支持实时更新
                { "DynamicCollectCount", new List<string> {
                ...
                // 动态评论数 - 支持实时更新
                { "DynamicCommentCount", new List<string> {
                ...
                { "likeButton", new List<string> {
                    ...
                    ".like-icon:not(.liked)"  // 通用未点赞图标
                } },

                // 已点赞状态的点赞按钮 - 基于真实HTML结构优化
                { "likeButtonActive", new List<string> {
                    ...
                    ".like-icon.liked.active"  // 通用已点赞激活图标
                } },

                // 点赞操作加载状态的按钮
                { "likeButtonLoading", new List<string> {
                    ...
                    ".like-icon.loading"  // 加载状态的点赞图标
                } },

                // ===== 收藏功能选择器 - 支持多状态检测 =====

                // 未收藏状态的收藏按钮 - 基于真实HTML结构优化
                { "favoriteButton", new List<string> {
                    ...
                    ".collect-icon:not(.collected)"  // 通用未收藏图标
                } },

                // 已收藏状态的收藏按钮 - 基于真实HTML结构优化
                { "favoriteButtonActive", new List<string> {
                    ...
                    ".collect-icon.collected.active"  // 通用已收藏激活图标
                } },

                // 收藏操作加载状态的按钮
                { "favoriteButtonLoading", new List<string> {
                    ...
                    ".collect-icon.loading"  // 加载状态的收藏图标
                } },

                // ===== 互动数据统计选择器 - 支持实时更新 =====

                // 点赞数文本显示
                { "likeCount", new List<string> {
                    ...
                    ".like-wrapper span.count"  // 点赞包装器中的计数span
                } },

                // 收藏数文本显示
                { "favoriteCount", new List<string> {
                    ...
                    ".collect-wrapper span.count"  // 收藏包装器中的计数span
                } },

                // 评论数文本显示（扩展现有选择器）
                { "commentCount", new List<string> {
                    ...
                    ".chat-wrapper span.count"  // 聊天包装器中的计数span
                } },

                // ===== 交互状态检测选择器 =====

                // 评论区域展开状态检测
                { "CommentAreaExpanded", new List<string> {
                ...
                // 按钮hover状态检测
                { "ShareButtonHovered", new List<string> {
        ...
        private void InitializePageStateSelectors()
        {
            _pageStateSelectors = new Dictionary<PageState, Dictionary<string, List<string>>>
            {
                [PageState.Explore] = new()
                {
                    ...
                    // 探索页面状态检测选择器
                    ["PageContainer"] = new List<string>
                    {
                        "#exploreFeeds",  // 探索页面主容器
                        ".channel-container",  // 频道容器
                        "[data-testid='explore-page']"  // 探索页面标识
                    },
                ...
                [PageState.SearchResult] = new()
                {
                    ...
                    ["PageContainer"] = new List<string>
                    {
                        ...
                        "[data-testid='search-result-page']"  // 搜索结果页面标识
                    },
