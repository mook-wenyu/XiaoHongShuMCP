...
const BAD_TOKENS = [
  // 词组（优先命中）
  "鎵撳紑", "绐楀彛", "娴忚鍣", "鍝嶅簲", "璇锋眰", "宸ヤ綔绌洪棿",
  "杩炴帴", "淇℃伅", "楠岃瘉", "瀹藉", "杞", "鑾峰彇", "鏌ヨ",
  "鎿嶄綔", "閿欒", "鍘熷", "瀹藉", "閲嶈瘯", "閫氳繃", "绔偣",
  "鎸囩汗", "闅忔満", "寤虹珛", "鏈繑鍥", "灏忕孩涔", "鑷姩鍖", "鏈嶅姟",
  "浜烘満", "鍔犺浇", "鎶ラ敊", "鎶涘嚭",
  // 单字高频
  "鈥", "锛", "锟", "鑳", "鐜", "鐢", "鐧", "缁", "鍙", "绠", "璁", "闈"
];
...
function main() {
  const roots = (process.env.CHECK_ENCODING_PATHS?.split(",").filter(Boolean) || DEFAULT_ROOTS)
